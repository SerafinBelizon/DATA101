/* Insertar Datos en Tablas Modelo CLIENTES (Direcciones) */ 
USE ODS; 
...
INSERT INTO ODS_DM_CIUDADES_ESTADOS (DE_CIUDAD, DE_ESTADO, ID_PAIS, FC_INSERT, FC_MODIFICACION) 
    SELECT DISTINCT 
    CASE WHEN TRIM(CITY) <> '' THEN UPPER(TRIM(CITY)) ELSE 'DESCONOCIDO' END CIUDAD,  
